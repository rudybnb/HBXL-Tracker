...
export interface IStorage {
  ...
  getJobCostItems(jobId: string): Promise<JobCostItem[]>;
  createJobCostItem(item: InsertJobCostItem): Promise<JobCostItem>;
  createJobCostItems(items: InsertJobCostItem[]): Promise<JobCostItem[]>;
  deleteJobCostItems(jobId: string): Promise<void>;
