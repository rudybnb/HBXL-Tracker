    ...
    <div className="bg-slate-800 rounded-lg border border-slate-700 p-6">
      ...
      <div className="mb-4">
        ...
        {uploadMutation.isSuccess && (
          <div className="mt-4 p-4 bg-green-900/20 border border-green-500/30 rounded-lg flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <CheckCircle2 className="h-6 w-6 text-green-500" />
              <div>
                <p className="text-green-400 font-medium">Job created successfully!</p>
                <p className="text-xs text-green-500/80">The QS Tender Document has been generated.</p>
              </div>
            </div>
            <Button
              onClick={() => window.location.href = '/job-assignments'} // Redirect to Jobs list where they can select View Tender
